...
class ScheduleRepositoryImpl implements ScheduleRepository {
  ...
  Future<ScheduleResponse> fetchSchedule({
    ...
    var urlStr = '$baseUrl${AppConstants.scheduleEndpoint}?page=$page&limit=$limit';
    ...
    try {
      ...
      developer.log('Status: ${response.statusCode}', name: 'ScheduleRepository');
      ...
      if (response.statusCode == 200 || response.statusCode == 201) {
        ...
        throw Exception('Schedule fetch failed. Status: ${response.statusCode}');
      }
    } catch (e) {
